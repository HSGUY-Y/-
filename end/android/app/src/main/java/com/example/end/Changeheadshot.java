...
public class Changeheadshot extends AppCompatActivity {
    private GridView gridView ;
    public static Changeheadshot changeheadshot;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Changeheadshot.this,Regedit1.class);
    ...
    protected void onResume() {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Changeheadshot.this,"正在上传",Toast.LENGTH_SHORT).show();
            }
        });
    }
    Handler handler = new Handler(){
        ...
        void change(final CommonVo commonVo){
            ...
            while (flag.equals(""));
            if(flag.equals("修改成功")){
                Toast.makeText(Changeheadshot.this,flag,Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Changeheadshot.this,Regedit1.class);
                intent.putExtra("headshot",commonVo.getUserEntities()[0].getHeadshot());
                intent.putExtra("account",account);
                startActivity(intent);
                finish();
                flag="";

...
public class CheckPS extends AppCompatActivity implements View.OnClickListener {
    ...
    Handler handler = new Handler(){
        ...
        void checkps(final CommonVo commonVo) {
            ...
            if (flag .equals( "验证成功")) {
                Intent intent;
                intent = new Intent(CheckPS.this, ChangePS.class);
                intent.putExtra("account",account);
                startActivity(intent);
                flag="";
            } else{
                Toast.makeText(CheckPS.this,flag,Toast.LENGTH_SHORT).show();
                flag="";
            }

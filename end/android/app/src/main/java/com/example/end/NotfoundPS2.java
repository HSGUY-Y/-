...
public class NotfoundPS2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notfoundps3);
        icon=findViewById(R.id.icon);
        conns=findViewById(R.id.conn);
        password=findViewById(R.id.password);
        repassword = findViewById(R.id.repassword);
        finishs=findViewById(R.id.finish);
    ...
    Handler handler = new Handler(){
        ...
        void change(final CommonVo commonVo) {
            ...
            while (flag.equals(""));
            if (flag .equals( "修改成功")) {
                Intent intent = new Intent(NotfoundPS2.this,MainActivity.class);
                ...
                Toast.makeText(NotfoundPS2.this,flag,Toast.LENGTH_SHORT).show();
                flag="";
            }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.icon:
                intent = new Intent(this,NotfoundPS1.class);
                startActivity(intent);
                finish();
                break;
            case R.id.finish:
